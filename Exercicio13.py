...
salario1 = float(input('Entre com o salário: '))

if salario1 <= 280:
    print('O seu salário era {} Reais'.format(salario1))
    salario = salario1 + (salario1 * (20 / 100))
    print('O novo salário é {} Reais'.format(salario))
    print('Você recebeu um aumento de 20%')
    aumento = salario - salario1
    print(aumento)

elif salario1 <= 700:
    print('O seu salário era {} Reais'.format(salario1))
    salario = salario1 + (salario1 * (15 / 100))
    print('O novo salário é {} Reais'.format(salario))
    ...
    print('O seu salário era {} Reais'.format(salario1))
    salario = salario1 + (salario1 * (10 / 100))
    print('O novo salário é {} Reais'.format(salario))
    ...
    print('O seu salário era {} Reais'.format(salario1))
    salario = salario1 + (salario1 * (5 / 100))
    print('O novo salário é {} Reais'.format(salario))
